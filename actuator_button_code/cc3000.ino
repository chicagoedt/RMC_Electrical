...
/////////////////////////////////////////////////////////////////////////////////////////////////HEMANT
volatile int actuatorcopy;   //second global variable to copy the current actuator value
volatile int digvalcopy;
////////////////////////////////////////////////////////////////////////////////////////////////HEMANT
...
void setup()
{
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////Hemant additions:
        pinMode(23, INPUT_PULLUP);     //initalize the internal pullup
        digitalWrite(23,HIGH);         //set up the pull up
        pinMode(21,INPUT_PULLUP);
        digitalWrite(21,HIGH);
        attachInterrupt(23, actUP, LOW);   //actuatorup code
        attachInterrupt(21, actDOWN, LOW);  //actuator down code
        sei();
        ///////////////////////////////////////////////////////////////////////////////////////////////////HEMANT ADDITIONS:
        //socketInit();
}
